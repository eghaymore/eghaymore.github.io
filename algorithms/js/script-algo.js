...
function showMyDetails(mousedLink)
{
	...
	switch (mousedLink.innerText)
	{
		case "Dijkstra's shortest path":
			msg1="Dijkstra's Algorithm";
			msg2="See my graph implementation on the 'Data structures' page";
			break;
		case 'Search':
			msg1="Search";
			msg2="Jump search, binary search";
			break;
		case 'Breadth-first search':
			msg1="Breadth-first search";
			msg2="See my graph implementation on the 'Data structures' page";
			break;
		case 'Depth-first search':
			msg1="Depth-first search";
			msg2="See my graph implementation on the 'Data structures' page";
			break;
